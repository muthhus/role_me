...
* :role_class_name
  ...
  * You must implement the `create_with_name(role_name)` method. To create a role with the name.
  * You must implement a `by_name(role_name)` scope. To select a role by it's name.
